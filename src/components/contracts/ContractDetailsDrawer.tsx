...
import type { SmartContractItem, ContractFunction } from '../../data/contractData';
...
export default function ContractDetailsDrawer({
  ...
  const handleExecuteSimulatedFunction = () => {
    ...
    <div className="fixed inset-0 z-50 overflow-hidden flex justify-end">
      ...
      <div className="relative w-full max-w-3xl bg-white h-full shadow-2xl z-10 flex flex-col overflow-hidden border-l border-slate-200 animate-in slide-in-from-right duration-200">
          ...
          <div className="flex items-center gap-2 border-b border-slate-200 -mb-4 pt-1">
            {[
              ...
              <button
                ...
                className={`pb-3 px-3 text-xs font-semibold transition-colors relative ${
                  activeTab === tab.id
        ...
        <div className="flex-1 overflow-y-auto p-6 space-y-6">
                ...
                <div className="bg-slate-800/90 p-3 rounded-lg border border-slate-700/80 flex items-center justify-between font-mono text-sm">
                  ...
                  <div className="flex items-center gap-2 ml-3 shrink-0">
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-700 hover:bg-slate-600 text-white rounded-md text-xs font-medium transition-colors"
                    >
              ...
              <div className="bg-white rounded-xl border border-slate-200 p-4 space-y-2">
                ...
                <div className="flex items-center justify-between bg-slate-50 p-2.5 rounded-lg border border-slate-200">
                  ...
                  <button
                    ...
                    className="p-1.5 text-slate-400 hover:text-slate-700 rounded ml-2"
                  >
          ...
          {/* Tab 2: FUNCTIONS (Read & Write with Interactive Demo Execution) */}
          {activeTab === 'functions' && (
            <div className="space-y-6">
                ...
                <div className="bg-blue-50/70 border-2 border-blue-300 rounded-xl p-5 space-y-4 animate-in fade-in">
                  ...
                  <div className="flex items-center justify-between pt-2">
                    <span className="text-[11px] text-slate-500">
                      * Safe demo simulation (no gas fees deducted)
                    </span>
                    <button
                      onClick={handleExecuteSimulatedFunction}
                      disabled={funcOutput.status === 'executing'}
                      className="inline-flex items-center gap-1.5 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-lg text-xs font-semibold transition-colors disabled:opacity-50"
                    >
                      ...
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1.5 bg-slate-50 hover:bg-blue-50 text-blue-600 border border-slate-200 rounded-lg text-xs font-semibold transition-colors shrink-0"
                          >
                      ...
                      >
                        <div className="flex items-start justify-between">
                          ...
                          <button
                            ...
                            className="inline-flex items-center gap-1 px-3 py-1.5 bg-purple-50 hover:bg-purple-100 text-purple-700 border border-purple-200 rounded-lg text-xs font-semibold transition-colors shrink-0"
                          >
                            <Play className="w-3 h-3 fill-current" />
                            Execute
                          </button>
              ...
              <div className="bg-white rounded-xl border border-slate-200 overflow-hidden shadow-sm">
                <table className="w-full text-left text-xs border-collapse">
                  ...
                  <tbody className="divide-y divide-slate-100">
                    {contract.recentActivity.map((act, idx) => (
