    ...
    <header className="h-16 bg-white border-b border-slate-200 flex items-center justify-between px-6 shrink-0 relative z-30">
      ...
      <div className="flex-1 flex items-center max-w-2xl relative" ref={searchRef}>
        ...
        {isSearchOpen && searchQuery.trim() && (
          <div className="absolute top-full left-0 right-0 mt-2 bg-white rounded-xl shadow-xl border border-slate-200 py-2 max-h-80 overflow-y-auto animate-in fade-in slide-in-from-top-2 duration-150">
