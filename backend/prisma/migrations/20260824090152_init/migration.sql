...
-- CreateIndex
CREATE UNIQUE INDEX "Portfolio_walletId_key" ON "Portfolio"("walletId");
...
-- AddForeignKey
ALTER TABLE "Portfolio" ADD CONSTRAINT "Portfolio_walletId_fkey" FOREIGN KEY ("walletId") REFERENCES "Wallet"("id") ON DELETE CASCADE ON UPDATE CASCADE;
